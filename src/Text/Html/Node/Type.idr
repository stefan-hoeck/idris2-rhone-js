...
public export %inline
data_ : List Attribute -> List Node -> Node
data_ = El Data True
...
public export %inline
ime : List Attribute -> List Node -> Node
ime = El Ime True
...
public export %inline
param : List Attribute -> List Node -> Node
param = El Param True
